...
<template>
  <progress class="progress is-primary is-small tick-clock" :value="timers.tick.elapsed"
    :max="timers.tick.duration"></progress>
  <div class="hero-body">
...
$family-primary: 'Fira Code', monospace;
...
$table-row-hover-background-color: #e6e6e6;
